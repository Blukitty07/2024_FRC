...
all_cost_string = f"* * * Total Costs: {all_costs:.2f} * * *"

Profit_heading = "* * * * Profit and Sales Targets * * * *"
profit_string = f"Profit Target: ${profit_target:.2f}"
selling_price = f"Minimum Selling Price ${selling_price:.2f}"
recommended_string = f"Recommended Price: ${recommended_price:.2f}"


to_write = [product_heading, Variable_heading, variable_txt, Fixed_heading, fixed_txt, all_cost_string,
            Profit_heading, profit_string, selling_price, recommended_string]
